      ...
      <div className=" mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-12">
          ...
          <div className="md:w-1/3 text-left w-full">
            <p className="uppercase text-[16px]  font-medium tracking-wide mb-3 uppercase ">FIRST STEPS</p>
            <h2 className="text-[40px]  font-bold leading-snug">
          ...
          <div className="grid md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-white/30 md:w-2/3">
            {/* Request A Demo */}
            <div className="flex flex-col items-start space-y-4 px-2 pb-10 md:pb-0 md:px-4 text-left ">
              <img src={cta1} alt="Request Demo" className="h-15" />
              <h3 className="text-[32px] font-bold leading-tight">Request A Demo</h3>
            ...
            <div className="flex flex-col items-start space-y-4 px-2 pb-10 md:pb-0 md:px-4 text-left">
              ...
              <h3 className="text-[32px] font-bold leading-tight ">Start Your Energy Scan</h3>
              <p className="text-[16px]">
            ...
            <div className="flex flex-col items-start space-y-4 px-2 pb-10 md:pb-0 md:px-4 text-left">
              ...
              <h3 className="text-[32px] font-bold leading-tight">Become A Partner</h3>
              <p className="text-[16px]">
