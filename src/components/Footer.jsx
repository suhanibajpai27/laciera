...
export default function Footer() {
  return (
    ...
    <div className="bg-bg text-white px-6 lg:px-20">
      ...
      <div className="container  px-0  py-4 lg:px-20 flex flex-col md:flex-row justify-between items-center text-sm text-gray-200 bg-[#E6F1F4] w-full max-w-[100vw] overflow-hidden text-text-1" >
